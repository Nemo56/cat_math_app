...
#         # === Инициализируем переменные до всех вызовов ===
#         self.style = ttk.Style()
#         self.current_theme = "light"  # ← ОБЯЗАТЕЛЬНО задаём значение здесь

#         # === Загружаем тему из файла (если есть) ===
...
#                     data = json.load(f)
#                     self.current_theme = data.get("theme", self.current_theme)  # ← Теперь self.current_theme существует
#             except Exception:
#                 pass
#         apply_theme(self.style, self.current_theme)

#     def show_main_menu(self):
#         self.clear_frame()  # Очищаем предыдущий фрейм
...
#         # Пересоздаём главное меню с новой темой
#         self.show_main_menu()
